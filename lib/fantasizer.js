...
/* Fetches the ID for a given team */
...
async function getTeamRoster(id) {
    let URL = 'http://www.fantasizr.com/getteammodal?league=' + FantasizrID + '&team=' + id;
...
async function getCharacterStats(arg) {
    let URL = 'http://www.fantasizr.com/getseasonstats?league=' + 6629648014245888;
    const nameCapitalized = arg.charAt(0).toUpperCase() + arg.slice(1)
